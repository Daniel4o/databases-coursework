...
@Entity
@Table(name="workout-notes-old")
public class WorkoutNoteOld {
    ...
    public WorkoutNoteOld() {}

    public WorkoutNoteOld(int id, int objectId, String description, Date deactive) {
        this.id = id;
